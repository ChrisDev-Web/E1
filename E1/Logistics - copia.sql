...
DROP PROCEDURE IF EXISTS sp_product_list_for_combo;
DROP PROCEDURE IF EXISTS sp_shipment_list_for_combo;
DROP PROCEDURE IF EXISTS sp_box_list_for_combo;
DROP PROCEDURE IF EXISTS sp_box_list_for_combo_by_shipment;
